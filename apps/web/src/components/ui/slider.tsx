  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className="bg-accent dark:bg-accent/30 relative grow overflow-hidden rounded-full data-horizontal:h-1.5 data-horizontal:w-full data-vertical:h-full data-vertical:w-1.5"
      >
